...
import 'package:test_visioad_app/core/common%20feature/presentation/widgets/button_widget.dart';
import 'package:test_visioad_app/core/styles/app_colors.dart';
import 'package:test_visioad_app/core/translations/l10n.dart';
...
class HelperUi {
  ...
  static List<T> filter<T>(String text, List<T> allResult) {
    List<T> results = [];
    if (text.isEmpty) {
